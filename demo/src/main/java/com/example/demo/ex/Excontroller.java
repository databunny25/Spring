...
public class Excontroller {
	...
	@RequestMapping("/ex5") //커맨드 객체 없이 파라미터 localhost:8081/ex4?username=xxx&userage=2
	public String ex5(String username, @RequestParam(name = "userage", required = false, defaultValue= "10") Integer age) { //@RequestParam 안적었을때는 age 파라미터로 안 넘겨도 에러 안남....적으면 파라미터 요구하면서 에러! required = false로 바꾸면 안 들어와도 된다!
